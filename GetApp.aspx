<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GetApp.aspx.cs" Inherits="GetApp" %>
...
<body>
    ...
    <div class="auto-style1">
        ...
        <h3>Application<strong> view</strong><table align="center" class="auto-style2">
            <tr>
            ...
            <tr>
                <td colspan="2">
                    <asp:Button ID="Button1" runat="server" BackColor="#FF9900" BorderColor="#FF9900" CssClass="auto-style3" Height="29px"  Text="Home" Width="83px" OnClick="Button1_Click" />
                </td>
            </tr>
            </table>
        </h3>
